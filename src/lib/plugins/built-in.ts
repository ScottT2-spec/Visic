...
export const builtInPlugins: PluginManifest[] = [
  // ─── Delivery Fee by Area ─────────────────────────────
  {
    ...
    version: "1.0.0",
    description: "Charge different delivery fees based on customer location. Set zones like Accra Central, Island, etc. with custom fees. Supports free delivery above a threshold.",
    author: "AfroStore",
    category: "delivery",
    icon: "🚚",
    isPremium: false,
    ...
    settingsSchema: [
      ...
      { key: "freeDeliveryAbove", label: "Free Delivery Above", type: "number", description: "Cart total above which delivery is free (0 = disabled)", default: 0, placeholder: "50000" },
      {
        ...
        default: [
          { name: "Accra Central", fee: 2000 },
          { name: "East Legon", fee: 3500 },
